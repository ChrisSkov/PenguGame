...
{
    public class PenguController : BaseCharacterController
    {
        ...
        {
            animator.SetFloat("speed", GetComponent<Rigidbody>().velocity.normalized.sqrMagnitude);
            // if (jump && animator.GetBool("jump") != true && _midAirJumpCount < 1)
            // {
            //     animator.SetBool("jump", true);
            // }
            // else if (animator.GetCurrentAnimatorStateInfo(0).normalizedTime <= 0.2)
            // {
        ...
        //     animator.ResetTrigger("midairjump");
        // }
